  ...
  switch (mir_event->type)
    {
      case mir_event_type_key:
        ...
        event->key.time = mir_event->key.event_time / 1000000;
      ...
      case mir_event_type_motion:
        ...
        if (mir_event->motion.action != mir_motion_action_hover_enter &&
            ...
            !_clutter_input_device_get_stage (device))
          {
            ...
            clutter_event_set_time (new_event, mir_event->motion.event_time / 1000000);
        ...
        if (event)
          {
            ...
            clutter_event_set_time (event, mir_event->motion.event_time / 1000000);
