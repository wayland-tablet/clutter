...
static void
clutter_text_paint_selection_rectangle_cb (ClutterText           *text,
                                           const ClutterActorBox *box,
                                           gpointer               user_data)
{
      ...
      if (position == priv->selection_bound)
      ...
      else
        {
          ...
          clutter_text_foreach_selection_rectangle
            (self, clutter_text_paint_selection_rectangle_cb, NULL);
        }
    }
}
                                               ...
                                               gpointer               user_data)
{
  ...
  _clutter_paint_volume_init_static (CLUTTER_ACTOR (text), &rect_volume);
